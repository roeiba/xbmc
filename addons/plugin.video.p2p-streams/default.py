		    ...
		    import subprocess
                    ...
                    if not sopcast_executable: pass
                        ...
                        if not users:
                            ...
                            download_tools().Downloader("http://p2p-strm.googlecode.com/svn/trunk/Windows-Files/srvany.exe",os.path.join(sopcast_executable.replace("SopCast.exe",""),"srvany.exe"),traducao(40167),traducao(40000)) 
                            xbmc.sleep(1000)
                            ret = mensagemprogresso.create(traducao(40000),traducao(40000))
                            xbmc.sleep(200)
